...
import { ArrowRightLeft, History, Loader2, Copy, Sparkles } from 'lucide-react';
          ...
          <div className="bg-white rounded-3xl w-full max-w-2xl max-h-[80vh] flex flex-col shadow-2xl animate-fade-in border border-slate-100">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              {history.length === 0 ? (
                ...
                history.map((record) => (
                  <div key={record.id} className="p-5 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:border-indigo-100 transition-all">
